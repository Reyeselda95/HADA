<%@ Page Title="INARI PLAYS - Inicio de Sesión Administrador" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoginAdmin.aspx.cs" Inherits="WebApplication.Account.LoginAdmin" %>
        ...
        <asp:Login ID="Login2" runat="server" ViewStateMode="Disabled" RenderOuterTable="false">
            <LayoutTemplate>
                ...
                <fieldset>
                    ...
                    <asp:Button ID="Button1" runat="server" CommandName="Login1" Text="Iniciar sesión" OnClick ="cambiainicio" />
                </fieldset>
            </LayoutTemplate>
        </asp:Login>

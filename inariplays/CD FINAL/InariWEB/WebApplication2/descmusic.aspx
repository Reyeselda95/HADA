...
<div id = "producto">
    ...
    <asp:GridView ID="GridViewvideo" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
         ...
         <asp:TemplateField>
            <ItemTemplate>
                <asp:TextBox ID="TextBox1" TextMode="MultiLine" Enabled="false" EnableViewState="false" Width="720px" Height="350px" runat="server" BackColor="#EFEEEF" Text='<%#  DataBinder.Eval(Container, "DataItem.descripcion") %>'>

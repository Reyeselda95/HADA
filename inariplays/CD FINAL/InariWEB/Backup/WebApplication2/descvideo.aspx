...
<div id = "producto">
    ...
    <asp:GridView ID="GridViewvideo1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="videojuegoidVideojuego" DataSourceID="SqlDataSource1" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Videojuego] WHERE ([videojuegoidVideojuego] = @videojuegoidVideojuego)">
        <SelectParameters>
            <asp:QueryStringParameter Name="videojuegoidVideojuego" QueryStringField="id" 
                Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>

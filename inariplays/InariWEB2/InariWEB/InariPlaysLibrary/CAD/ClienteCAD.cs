...
namespace InariPlaysLibrary.CAD
{
    public class ClienteCAD
    {
        ...
        public static bool esCliente(string mail, string password)
        {
            bool existe = false;
            ...
            try
            {
                ...
                SqlCommand com = new SqlCommand("Select * from Cliente where email like '%" + mail + "%' and password like '%" + password + "%'", c);
                SqlDataReader dr = com.ExecuteReader();
            ...
            try
            {
                ...
                string consulta = "UPDATE Cliente " +
                                 " SET password = '" + cliente.Password +
                                   ...
                                   "', cp= " + cliente.Cp + "WHERE NIF like'%" + cliente.NIF + "%'";
        ...
        public bool borrarCliente() 
        {
            ...
            try
            {
                ...
                string consulta = "DELETE from Cliente WHERE NIF like '%" + cliente.NIF + "%'";
        ...
        public static ClienteEN clientePorNif(string nif) {
            ...
            {
                c.Open();
                SqlCommand com = new SqlCommand("Select * from Cliente WHERE NIF like'%" + nif + "%'", c);
                SqlDataReader dr = com.ExecuteReader();
                while (dr.Read())
                {

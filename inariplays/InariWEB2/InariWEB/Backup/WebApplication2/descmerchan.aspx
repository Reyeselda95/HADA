<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="descmerchan.aspx.cs" Inherits="WebApplication2.descmerchan" %>
...
<div id = "producto">
    ...
    <asp:GridView ID="GridViewvideo1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="merchandisingIdMerchandising" DataSourceID="SqlDataSource1" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [merchandising] WHERE ([merchandisingIdMerchandising] = @merchandisingIdMerchandising)">
        <SelectParameters>
            <asp:QueryStringParameter Name="merchandisingIdMerchandising" QueryStringField="id" 
                Type="Int32" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>

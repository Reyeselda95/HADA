	...
	<div class="sp-content">
      ...
      <div class="ofertas">
            <ul>
                ...
                <li>
                    <asp:HyperLink id="comprar" runat="server" NavigateUrl="~/descvideo.aspx"><img src="Images/comprar.JPG" /></asp:HyperLink>
                </li>
                <li>
                ...
                <li>
                    <asp:HyperLink id="comprar2" runat="server" NavigateUrl="~/vistapeluche.aspx"><img src="Images/comprar.JPG" /></asp:HyperLink>
                </li>
